...
const HistoryPage: React.FC = () => {
    return (
        <>
            <Navbar />
              <div className="mt-12 px-5 pb-0 md:px-80 flex flex-col justify-center items-center py-20 bg-cover bg-top bg-no-repeat bg-[url('../public/background/history_bg_1.png')]">
                <h4 className="my-16 text-3xl font-semibold text-white bg-black">The History of MUE</h4>
              </div>
