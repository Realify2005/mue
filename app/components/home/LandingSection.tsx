...
const LandingSection: React.FC = () => {
    return (
        <div className="mt-16 grid gap-5 justify-items-center align-items-center">
            <MUExUMSU />
            <h3 className="text-4xl font-extrabold text-center dark:text-white">Melbourne University Esports [MUE]</h3>
            <p className="text-base">The best of Unimelb spirit, now in Esports</p>
