...
const WelcometoMUE: React.FC = () => {
    return (
        <div className="mt-12 px-5 md:px-80 flex flex-col justify-center items-center py-20 bg-cover bg-bottom bg-no-repeat bg-[url('../public/background/home_bg_2.jpg')]">
            ...
            <p className="my-6 text-base text-white">On this website, you can check out all about MUE - our upcoming events, focused games, sponsors&apos;s information and membership benefits, the committee, and even the history of MUE&apos;s founding! Feel free to take your time to navigate round this site!</p>
        </div>
    )
}
